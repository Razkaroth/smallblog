...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/raz/jale/contact-points/smalldata/libs/interfaces/src/lib/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "",
  "inlineSchemaHash": "92c213017510120594feb363a2f8b9d7f590f6a93c03ddbabadf4f3ad9fd7927",
  "noEngine": false
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/interfaces/src/lib/client",
    "interfaces/src/lib/client",
  ]
...
path.join(process.cwd(), "libs/interfaces/src/lib/client/libquery_engine-debian-openssl-1.1.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/interfaces/src/lib/client/schema.prisma")
